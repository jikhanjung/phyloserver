...
def nkdata_download(request):
    ...
    col_list = ['strat_unit','strat_unit_code','lithology','lithology_code','fossil_group','group_code','location','location_code',
                'chronounit','chronounit_id','species_name','genus_name','revised_species_name','revised_genus_name','source','source_eng']
    ...
    for occ in occ_list:
        ...
        worksheet.write_row(row_idx, 0, [occ.get_strat_unit_display(), occ.strat_unit, occ.get_lithology_display(), occ.lithology, 
                         ...
                         occ.species_name, occ.genus_name, occ.revised_species_name, occ.revised_genus_name, occ.source,occ.source_eng])
        row_idx += 1
...
def show_combined_cluster(request): 
    user_obj = get_user_obj( request )
