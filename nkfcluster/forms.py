...
from .models import NkfOccurrence, NkfOccurrence1, NkfOccurrence2, NkfOccurrence3, NkfOccurrence4, NkfOccurrence5, NkfOccurrence6, PbdbOccurrence, NkfLocality, ChronoUnit
...
class NkfOccurrenceForm6(ModelForm):
    class Meta:
        model = NkfOccurrence6
        fields = ['type', 'plate','figure','species','preservation','preservation_eng','location','unit','unit_eng', 'strat_range', 'latitude','longitude','source']
